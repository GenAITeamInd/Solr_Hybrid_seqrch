...
examples = [
    ...
    {
        "user_query": 'documents of type tabular data created by author1 in last 30 days',
        "solr_query": 'type:"tabular data" AND author:"author1" AND date_of_publish:[NOW-30DAYS TO NOW]'
    },
    {
    ...
    {
        "user_query": 'get documents published by brand1 before 2023-01-01',
        "solr_query": 'date_of_publish:[* TO 2023-01-01T00:00:00Z] AND brand:"brand1"'
    },
    {

        "user_query": 'get documents written by sounak before 2025',
        "solr_query": 'date_of_publish:[* TO 2025-01-01T00:00:00Z] AND author:"sounak"'
